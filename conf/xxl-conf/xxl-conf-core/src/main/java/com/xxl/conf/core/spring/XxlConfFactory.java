 ...
 */
public class XxlConfFactory extends InstantiationAwareBeanPostProcessorAdapter implements
     ...
     */
    public static void refreshBeanField(final BeanRefreshXxlConfListener.BeanField beanField,
                                        final String value, Object bean) {
        if (bean == null) {
        ...
        if (propertyDescriptor != null && propertyDescriptor.getWriteMethod() != null) {
            ...
            ReflectionUtils.doWithFields(bean.getClass(), new ReflectionUtils.FieldCallback() {
                @Override
                public void doWith(Field fieldItem) throws IllegalArgumentException,
                                                    IllegalAccessException {
                    if (beanField.getProperty().equals(fieldItem.getName())) {
                        try {
                            Object valueObj = FieldReflectionUtil.parseValue(fieldItem.getType(),
                                value);
                            ...
                            logger.info(
                                ">>>>>>>>>>> xxl-conf, refreshBeanField[field] success, {}#{}:{}",
                                beanField.getBeanName(), beanField.getProperty(), value);
